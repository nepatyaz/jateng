...
@Component({
  selector: 'app-otorisasi-rekening',
  templateUrl: './otorisasi-rekening.component.html',
  styleUrls: ['./otorisasi-rekening.component.css']
})
export class OtorisasiRekeningComponent implements OnInit {
